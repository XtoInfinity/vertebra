...
pickle.dump(classes, open(file_url+"classes.pkl", "wb"))
...
for document in documents:
    ...
    word_patterns = [lemmetizer.lemmatize(
...
hist = model.fit(np.array(train_x), np.array(
    train_y), epochs=200, batch_size=5)
model.save(file_url+"chatbotmodel.h5", hist)
print("Done")
